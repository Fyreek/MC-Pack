...
// Add crafting recipe
recipes.addShaped(<storagedrawers:controller>, [[<tconstruct:large_plate>, <tconstruct:large_plate>, <tconstruct:large_plate>],[<minecraft:comparator>, <ore:drawerBasic>, <minecraft:comparator>], [<tconstruct:large_plate>, <stevescarts:modulecomponents:46>, <tconstruct:large_plate>]]);
recipes.addShaped(<storagedrawers:compdrawers>, [[<minecraft:stone>, <tconstruct:large_plate>, <minecraft:stone>],[<minecraft:piston>, <ore:drawerBasic>, <minecraft:piston>], [<minecraft:stone>, <logisticspipes:pipe_basic>, <minecraft:stone>]]);
