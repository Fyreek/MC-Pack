...
recipes.addShaped(<logisticspipes:frame>, [[<minecraft:stone>, <extrautils2:ingredients>, <minecraft:stone>],[<tconstruct:fancy_frame:2>, <logisticspipes:pipe_basic>, <tconstruct:fancy_frame:3>], [<immersiveengineering:wooden_decoration:1>, <logisticspipes:module_crafter>, <immersiveengineering:wooden_decoration:1>]]);
