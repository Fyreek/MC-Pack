...
// Add crafting recipe
recipes.addShaped(<compactmachines3:fieldprojector>, [[<immersiveengineering:metal_decoration2:4>, <contenttweaker:redstone_plate>, <immersiveengineering:metal_decoration2:4>],[<actuallyadditions:block_misc:6>, <compactmachines3:psd>, <actuallyadditions:block_misc:6>], [<ore:manaDiamond>, <contenttweaker:machine_base>, <ore:manaDiamond>]]);
